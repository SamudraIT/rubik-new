...
class ZPencatatanKasusDbdChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static ?string $chartId = 'pencatatanKasusDbdChart';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Laporan Pencatatan Kasus DBD';
